...
%oneside betyder at der ikke er nogen forskydning mellem lige og    ulige siders alignment #viprinterikkeenbog
...
\usepackage[dvipsnames,table]{xcolor}				% Definer farver med \definecolor. Se mere: http://en.wikibooks.org/wiki/LaTeX/Colors
...
% Importere \seqsplit kommandoen som kan splitte karaktersekvenser længere en sidebreden til multilinje 
\usepackage{seqsplit}

%%%% BRUGERDEFINEREDE INDSTILLINGER %%%%

% ¤¤ Marginer ¤¤ %
\setlrmarginsandblock{3cm}{2cm}{*}		% \setlrmarginsandblock{Indbinding}{Kant}{Ratio}
\setulmarginsandblock{2.5cm}{3.0cm}{*}		% \setulmarginsandblock{Top}{Bund}{Ratio}
\checkandfixthelayout 						% Oversaetter vaerdier til brug for andre pakker

%\usepackage{showframe} % NICE: viser layout grænser
...
\bibliographystyle{unsrt}			% Udseende af litteraturlisten (Harvard-metoden - skift til fx 'plain' for tal)
...
\makeevenhead{Uni}{Master students now}{}{\leftmark}				% Lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
\makeoddhead{Uni}{\leftmark}{}{Aalborg University}		% Ulige siders sidehoved (\makeoddhead{Navn}{Venstre}{Center}{Hoejre})
...
\usepackage[labelfont=bf,format=hang,font={small,sl}]{caption}

\usepackage{tikz}
\usetikzlibrary{arrows.meta,decorations.markings,decorations.pathreplacing,shapes,patterns}
 
\usepackage{array}
\newcommand{\rod}[1]{
    \textcolor{red}{#1}
    }
\newcommand{\prettyinpink}[1]{
    \textcolor{magenta}{#1}
    }
